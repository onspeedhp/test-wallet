...
const clientId = process.env.REACT_APP_CLIENT_ID_WEB3_AUTH!; // get from https://dashboard.web3auth.io
      ...
      try {
        const web3auth = new Web3Auth({
          ...
          chainConfig: {
            ...
            rpcTarget: process.env.REACT_APP_RPC_HELIUS, // This is the public RPC we have added, please pass on your own endpoint while creating an app
          },
